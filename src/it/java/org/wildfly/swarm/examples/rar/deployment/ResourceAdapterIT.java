...
public class ResourceAdapterIT extends AbstractIntegrationTest {
  ...
  public void testIt() throws Exception {
    final Log log = getStdOutLog();
    assertThatLog(log)
        .hasLineContaining("WFLYJCA0002: Bound JCA ConnectionFactory [java:global/XADiskCF]");
    assertThatLog(log)
        .hasLineContaining("WFLYSRV0010: Deployed \"xadisk.rar\"");
